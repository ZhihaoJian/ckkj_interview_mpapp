...
export const teachers = [
    {
        title: 'Allam Maalla (阿拉拇)',
        note: '工学博士，开放数据商业应用研究所所长',
        thumb: AllamMaalla,
        detail: `
            Allam Maalla（阿拉拇），工学博士。开放数据商业应用研究所所长，研究方向：大数据，云计算及其应用。
        `,
        tags: ['大数据', '云计算', '外籍人才', '博士后', '大牛', '研究所所长'],
        major: ['大数据', '云计算及其应用'],
        timeline: [
            {
                title: '2012-2014',
                content: ['武汉理工大学交通运输工程领域从事博士后研究工作']
            },
            {
                title: '2010-2012',
                content: ['武汉理工大学管理科学与工程领域从事博士后研究工作']
            },
            {
                title: '2010',
                content: ['博士毕业于武汉理工大学通信与信息工程专业']
            },
            {
                title: '2007',
                content: ['硕士毕业于武汉理工大学通信工程专业']
            }
        ],
        prizes: [
            {
                title: '广东省特色重点学科建设项目（粤教研函[2017]1号；项目号-TSZDXK201601）主要成员',
            },
            {
                title: '国内外期刊等发表学术论文30余篇',
            },
            {
                title: '主持和参与项目重点课题等15项',
            },
            {
                title: '担任 IEEE,EI国际技术委员会委员(IEEE,EI ) International Technical Program Committee TPC，EI国际期刊和会议审稿人',
            },
            {
                title: '广东省外籍高层次人才认定外籍知名专家学者'
            }
        ]
    },
    {
        ...
        project: [
            ...
            {
                title: '2011.5',
                content: ['《民办院校计算机组成原理教学现状分析及解决对策》论文，并发表与《考试周刊》']
            }
        ],
        prizes: [
            {
    ...
    },
    {
        ...
        project: [
            {
                title: '教育部规划课题课《省域高校网络辅助教学信息保障系统研究》'
            },
            {
    ...
    },
    {
        ...
        thumb: HeWenHai,
        detail: `
        何文海，男，副教授，软件教研室主任。毕业于中山大学。\n主讲《计算机基础Ⅰ》、《计算机基础Ⅱ》、《网络程序设计》、《面向对象程序设计》、《C语言程序设计》、《Microsoft.NET》、《Java程序设计》等课程。
    　　热爱计算机科学，对哲学、经济学有着浓厚兴趣。希望可以进步每一天，期望成为一个可以帮助他人的人，期待与同学们一起进步每一天。
        `,
        tags: ['副教授', '优秀教师', '哲学', '经济学', '计算机科学'],
        major: ['软件工程', '软件架构', 'web架构及其应用', '机器学习'],
        project: [
            {
                title: '参与“华南师范大学本科教学质量保障监控系统”等项目系统的设计与开发'
            },
            {
                title: '主编、参编《大学计算机网络基础》等4部教材'
            },
            {
                title: '发表教学研究和计算机理论与技术方面的论文多篇'
            },
            {
                title: '多次被评为学院年度优秀教师'
            }
